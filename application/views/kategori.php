                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="poster_event">
                            <div class="thumbnail">
                                <a href="<?php echo base_url(); ?>index.php/website/detail"><img src="<?php echo base_url(); ?>assets/images/sample1.jpeg" alt="sample"></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div class="poster_event">
                            <div class="thumbnail">
                                <a href="<?php echo base_url(); ?>index.php/website/detail"><img src="<?php echo base_url(); ?>assets/images/sample2.jpeg" alt="sample"></a>
                            </div>
                        </div>
                        <h4><a href="<?php echo base_url() ?>index.php/website/detail">Nama Event</a></h4>
                        <div class="row">
